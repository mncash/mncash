#############################################################################
# Makefile for building: MNcash-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Feb 13 15:48:23 2018
# Project:  mncash-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=- -o Makefile mncash-qt.pro
#############################################################################
...
INCPATH       = -I/usr/lib64/qt/mkspecs/linux-g++ -I/usr/lib64/qt/include/QtCore -I/usr/lib64/qt/include/QtNetwork -I/usr/lib64/qt/include/QtGui -I/usr/lib64/qt/include -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1 -Wl,-rpath,/usr/lib64/qt/lib
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt/lib /home/marciano/mncash/src/leveldb/libleveldb.a /home/marciano/mncash/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQtGui -L/usr/lib64/qt/lib -L/usr/X11R6/lib64 -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = src/txdb-leveldb.cpp \
		...
		build/moc_anonsendconfig.cpp \
		build/moc_addeditmncashnode.cpp \
		build/moc_mncashnodeconfigdialog.cpp \
...
OBJECTS       = build/txdb-leveldb.o \
		...
		build/addeditmncashnode.o \
		build/mncashnodeconfigdialog.o \
		...
		build/moc_anonsendconfig.o \
		build/moc_addeditmncashnode.o \
		build/moc_mncashnodeconfigdialog.o \
...
DIST          = /usr/lib64/qt/mkspecs/common/unix.conf \
		...
		/usr/lib64/qt/mkspecs/features/static.prf \
...
$(TARGET): /home/marciano/mncash/src/leveldb/libleveldb.a /home/marciano/mncash/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_statisticspage.h build/ui_blockbrowser.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_chatwindow.h build/ui_sendmessagesdialog.h build/ui_sendmessagesentry.h build/ui_messagepage.h build/ui_optionsdialog.h build/ui_stakereportdialog.h build/ui_anonsendconfig.h build/ui_addeditmncashnode.h build/ui_mncashnodeconfigdialog.h build/ui_masternodemanager.h build/ui_calcdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: mncash-qt.pro  /usr/lib64/qt/mkspecs/linux-g++/qmake.conf /usr/lib64/qt/mkspecs/common/unix.conf \
		/usr/lib64/qt/mkspecs/common/linux.conf \
		/usr/lib64/qt/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile mncash-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/MNcash-qt1.0.0.0 || $(MKDIR) build/MNcash-qt1.0.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/MNcash-qt1.0.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/MNcash-qt1.0.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/qt/statisticspage.h src/qt/blockbrowser.h src/qt/calcdialog.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/coincontrol.h src/sync.h src/util.h src/uint256.h src/uint256_t.h src/kernel.h src/scrypt.h src/pbkdf2.h src/serialize.h src/strlcpy.h src/main.h src/miner.h src/net.h src/key.h src/db.h src/txdb.h src/walletdb.h src/script.h src/init.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/qvalidatedtextedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/bloom.h src/checkqueue.h src/hash.h src/hashblock.h src/limitedmap.h src/sph_blake.h src/sph_bmw.h src/sph_cubehash.h src/sph_echo.h src/sph_groestl.h src/sph_jh.h src/sph_keccak.h src/sph_luffa.h src/sph_shavite.h src/sph_simd.h src/sph_skein.h src/sph_fugue.h src/sph_hamsi.h src/sph_types.h src/threadsafety.h src/txdb-leveldb.h src/qt/stakereportdialog.h src/qt/sendmessagesdialog.h src/qt/sendmessagesentry.h src/qt/messagemodel.h src/qt/messagepage.h src/smessage.h src/lz4/lz4.h src/xxhash/xxhash.h src/zerocoin/Accumulator.h src/zerocoin/AccumulatorProofOfKnowledge.h src/zerocoin/Coin.h src/zerocoin/CoinSpend.h src/zerocoin/Commitment.h src/zerocoin/ParamGeneration.h src/zerocoin/Params.h src/zerocoin/SerialNumberSignatureOfKnowledge.h src/zerocoin/SpendMetaData.h src/zerocoin/ZeroTest.h src/qt/anonsendconfig.h src/masternode.h src/anonsend.h src/instantx.h src/activemasternode.h src/spork.h src/qt/addeditmncashnode.h src/qt/mncashnodeconfigdialog.h src/qt/masternodemanager.h build/MNcash-qt1.0.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/MNcash-qt1.0.0.0/ && $(COPY_FILE) --parents src/txdb-leveldb.cpp src/bloom.cpp src/hash.cpp src/blake.c src/bmw.c src/cubehash.c src/echo.c src/groestl.c src/jh.c src/keccak.c src/luffa.c src/shavite.c src/simd.c src/skein.c src/fugue.c src/hamsi.c src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/statisticspage.cpp src/qt/blockbrowser.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/qt/calcdialog.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/miner.cpp src/init.cpp src/net.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/qvalidatedtextedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-arm.S src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt.cpp src/qt/sendmessagesdialog.cpp src/qt/sendmessagesentry.cpp src/qt/messagemodel.cpp src/qt/messagepage.cpp src/rpcsmessage.cpp src/smessage.cpp src/pbkdf2.cpp src/qt/stakereportdialog.cpp src/zerocoin/Accumulator.cpp src/zerocoin/AccumulatorProofOfKnowledge.cpp src/zerocoin/Coin.cpp src/zerocoin/CoinSpend.cpp src/zerocoin/Commitment.cpp src/zerocoin/ParamGeneration.cpp src/zerocoin/Params.cpp src/zerocoin/SerialNumberSignatureOfKnowledge.cpp src/zerocoin/SpendMetaData.cpp src/zerocoin/ZeroTest.cpp src/qt/anonsendconfig.cpp src/masternode.cpp src/anonsend.cpp src/rpcanonsend.cpp src/instantx.cpp src/activemasternode.cpp src/spork.cpp src/masternodeconfig.cpp src/qt/addeditmncashnode.cpp src/qt/mncashnodeconfigdialog.cpp src/qt/masternodemanager.cpp build/MNcash-qt1.0.0.0/ && $(COPY_FILE) --parents src/qt/forms/coincontroldialog.ui src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/statisticspage.ui src/qt/forms/blockbrowser.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/chatwindow.ui src/qt/forms/sendmessagesdialog.ui src/qt/forms/sendmessagesentry.ui src/qt/forms/messagepage.ui src/qt/forms/optionsdialog.ui src/qt/forms/stakereportdialog.ui src/qt/forms/anonsendconfig.ui src/qt/forms/addeditmncashnode.ui src/qt/forms/mncashnodeconfigdialog.ui src/qt/forms/masternodemanager.ui src/qt/forms/calcdialog.ui build/MNcash-qt1.0.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/MNcash-qt1.0.0.0/ && (cd `dirname build/MNcash-qt1.0.0.0` && $(TAR) MNcash-qt1.0.0.0.tar MNcash-qt1.0.0.0 && $(COMPRESS) MNcash-qt1.0.0.0.tar) && $(MOVE) `dirname build/MNcash-qt1.0.0.0`/MNcash-qt1.0.0.0.tar.gz . && $(DEL_FILE) -r build/MNcash-qt1.0.0.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/marciano/mncash/src/leveldb/libleveldb.a; cd /home/marciano/mncash/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/marciano/mncash/src/leveldb/libleveldb.a: FORCE
	cd /home/marciano/mncash/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/marciano/mncash/build/build.h: FORCE
	cd /home/marciano/mncash; /bin/sh share/genbuild.sh /home/marciano/mncash/build/build.h
...
src/qt/locale/bitcoin_af_ZA.qm: src/qt/locale/bitcoin_af_ZA.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_af_ZA.ts -qm src/qt/locale/bitcoin_af_ZA.qm

src/qt/locale/bitcoin_ar.qm: src/qt/locale/bitcoin_ar.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ar.ts -qm src/qt/locale/bitcoin_ar.qm

src/qt/locale/bitcoin_be_BY.qm: src/qt/locale/bitcoin_be_BY.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_be_BY.ts -qm src/qt/locale/bitcoin_be_BY.qm

src/qt/locale/bitcoin_bg.qm: src/qt/locale/bitcoin_bg.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_bg.ts -qm src/qt/locale/bitcoin_bg.qm

src/qt/locale/bitcoin_bs.qm: src/qt/locale/bitcoin_bs.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_bs.ts -qm src/qt/locale/bitcoin_bs.qm

src/qt/locale/bitcoin_ca.qm: src/qt/locale/bitcoin_ca.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ca.ts -qm src/qt/locale/bitcoin_ca.qm

src/qt/locale/bitcoin_ca@valencia.qm: src/qt/locale/bitcoin_ca@valencia.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ca@valencia.ts -qm src/qt/locale/bitcoin_ca@valencia.qm

src/qt/locale/bitcoin_ca_ES.qm: src/qt/locale/bitcoin_ca_ES.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ca_ES.ts -qm src/qt/locale/bitcoin_ca_ES.qm

src/qt/locale/bitcoin_cs.qm: src/qt/locale/bitcoin_cs.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_cs.ts -qm src/qt/locale/bitcoin_cs.qm

src/qt/locale/bitcoin_cy.qm: src/qt/locale/bitcoin_cy.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_cy.ts -qm src/qt/locale/bitcoin_cy.qm

src/qt/locale/bitcoin_da.qm: src/qt/locale/bitcoin_da.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_da.ts -qm src/qt/locale/bitcoin_da.qm

src/qt/locale/bitcoin_de.qm: src/qt/locale/bitcoin_de.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_de.ts -qm src/qt/locale/bitcoin_de.qm

src/qt/locale/bitcoin_el_GR.qm: src/qt/locale/bitcoin_el_GR.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_el_GR.ts -qm src/qt/locale/bitcoin_el_GR.qm

src/qt/locale/bitcoin_en.qm: src/qt/locale/bitcoin_en.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_en.ts -qm src/qt/locale/bitcoin_en.qm

src/qt/locale/bitcoin_eo.qm: src/qt/locale/bitcoin_eo.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_eo.ts -qm src/qt/locale/bitcoin_eo.qm

src/qt/locale/bitcoin_es.qm: src/qt/locale/bitcoin_es.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_es.ts -qm src/qt/locale/bitcoin_es.qm

src/qt/locale/bitcoin_es_CL.qm: src/qt/locale/bitcoin_es_CL.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_es_CL.ts -qm src/qt/locale/bitcoin_es_CL.qm

src/qt/locale/bitcoin_es_DO.qm: src/qt/locale/bitcoin_es_DO.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_es_DO.ts -qm src/qt/locale/bitcoin_es_DO.qm

src/qt/locale/bitcoin_es_MX.qm: src/qt/locale/bitcoin_es_MX.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_es_MX.ts -qm src/qt/locale/bitcoin_es_MX.qm

src/qt/locale/bitcoin_es_UY.qm: src/qt/locale/bitcoin_es_UY.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_es_UY.ts -qm src/qt/locale/bitcoin_es_UY.qm

src/qt/locale/bitcoin_et.qm: src/qt/locale/bitcoin_et.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_et.ts -qm src/qt/locale/bitcoin_et.qm

src/qt/locale/bitcoin_eu_ES.qm: src/qt/locale/bitcoin_eu_ES.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_eu_ES.ts -qm src/qt/locale/bitcoin_eu_ES.qm

src/qt/locale/bitcoin_fa.qm: src/qt/locale/bitcoin_fa.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_fa.ts -qm src/qt/locale/bitcoin_fa.qm

src/qt/locale/bitcoin_fa_IR.qm: src/qt/locale/bitcoin_fa_IR.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_fa_IR.ts -qm src/qt/locale/bitcoin_fa_IR.qm

src/qt/locale/bitcoin_fi.qm: src/qt/locale/bitcoin_fi.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_fi.ts -qm src/qt/locale/bitcoin_fi.qm

src/qt/locale/bitcoin_fr.qm: src/qt/locale/bitcoin_fr.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_fr.ts -qm src/qt/locale/bitcoin_fr.qm

src/qt/locale/bitcoin_fr_CA.qm: src/qt/locale/bitcoin_fr_CA.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_fr_CA.ts -qm src/qt/locale/bitcoin_fr_CA.qm

src/qt/locale/bitcoin_gl.qm: src/qt/locale/bitcoin_gl.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_gl.ts -qm src/qt/locale/bitcoin_gl.qm

src/qt/locale/bitcoin_he.qm: src/qt/locale/bitcoin_he.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_he.ts -qm src/qt/locale/bitcoin_he.qm

src/qt/locale/bitcoin_hi_IN.qm: src/qt/locale/bitcoin_hi_IN.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_hi_IN.ts -qm src/qt/locale/bitcoin_hi_IN.qm

src/qt/locale/bitcoin_hr.qm: src/qt/locale/bitcoin_hr.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_hr.ts -qm src/qt/locale/bitcoin_hr.qm

src/qt/locale/bitcoin_hu.qm: src/qt/locale/bitcoin_hu.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_hu.ts -qm src/qt/locale/bitcoin_hu.qm

src/qt/locale/bitcoin_id_ID.qm: src/qt/locale/bitcoin_id_ID.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_id_ID.ts -qm src/qt/locale/bitcoin_id_ID.qm

src/qt/locale/bitcoin_it.qm: src/qt/locale/bitcoin_it.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_it.ts -qm src/qt/locale/bitcoin_it.qm

src/qt/locale/bitcoin_ja.qm: src/qt/locale/bitcoin_ja.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ja.ts -qm src/qt/locale/bitcoin_ja.qm

src/qt/locale/bitcoin_ka.qm: src/qt/locale/bitcoin_ka.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ka.ts -qm src/qt/locale/bitcoin_ka.qm

src/qt/locale/bitcoin_kk_KZ.qm: src/qt/locale/bitcoin_kk_KZ.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_kk_KZ.ts -qm src/qt/locale/bitcoin_kk_KZ.qm

src/qt/locale/bitcoin_ko_KR.qm: src/qt/locale/bitcoin_ko_KR.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ko_KR.ts -qm src/qt/locale/bitcoin_ko_KR.qm

src/qt/locale/bitcoin_ky.qm: src/qt/locale/bitcoin_ky.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ky.ts -qm src/qt/locale/bitcoin_ky.qm

src/qt/locale/bitcoin_la.qm: src/qt/locale/bitcoin_la.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_la.ts -qm src/qt/locale/bitcoin_la.qm

src/qt/locale/bitcoin_lt.qm: src/qt/locale/bitcoin_lt.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_lt.ts -qm src/qt/locale/bitcoin_lt.qm

src/qt/locale/bitcoin_lv_LV.qm: src/qt/locale/bitcoin_lv_LV.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_lv_LV.ts -qm src/qt/locale/bitcoin_lv_LV.qm

src/qt/locale/bitcoin_ms_MY.qm: src/qt/locale/bitcoin_ms_MY.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ms_MY.ts -qm src/qt/locale/bitcoin_ms_MY.qm

src/qt/locale/bitcoin_nb.qm: src/qt/locale/bitcoin_nb.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_nb.ts -qm src/qt/locale/bitcoin_nb.qm

src/qt/locale/bitcoin_nl.qm: src/qt/locale/bitcoin_nl.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_nl.ts -qm src/qt/locale/bitcoin_nl.qm

src/qt/locale/bitcoin_pam.qm: src/qt/locale/bitcoin_pam.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_pam.ts -qm src/qt/locale/bitcoin_pam.qm

src/qt/locale/bitcoin_pl.qm: src/qt/locale/bitcoin_pl.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_pl.ts -qm src/qt/locale/bitcoin_pl.qm

src/qt/locale/bitcoin_pt_BR.qm: src/qt/locale/bitcoin_pt_BR.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_pt_BR.ts -qm src/qt/locale/bitcoin_pt_BR.qm

src/qt/locale/bitcoin_pt_PT.qm: src/qt/locale/bitcoin_pt_PT.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_pt_PT.ts -qm src/qt/locale/bitcoin_pt_PT.qm

src/qt/locale/bitcoin_ro_RO.qm: src/qt/locale/bitcoin_ro_RO.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ro_RO.ts -qm src/qt/locale/bitcoin_ro_RO.qm

src/qt/locale/bitcoin_ru.qm: src/qt/locale/bitcoin_ru.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ru.ts -qm src/qt/locale/bitcoin_ru.qm

src/qt/locale/bitcoin_sah.qm: src/qt/locale/bitcoin_sah.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_sah.ts -qm src/qt/locale/bitcoin_sah.qm

src/qt/locale/bitcoin_sk.qm: src/qt/locale/bitcoin_sk.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_sk.ts -qm src/qt/locale/bitcoin_sk.qm

src/qt/locale/bitcoin_sl_SI.qm: src/qt/locale/bitcoin_sl_SI.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_sl_SI.ts -qm src/qt/locale/bitcoin_sl_SI.qm

src/qt/locale/bitcoin_sq.qm: src/qt/locale/bitcoin_sq.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_sq.ts -qm src/qt/locale/bitcoin_sq.qm

src/qt/locale/bitcoin_sr.qm: src/qt/locale/bitcoin_sr.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_sr.ts -qm src/qt/locale/bitcoin_sr.qm

src/qt/locale/bitcoin_sv.qm: src/qt/locale/bitcoin_sv.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_sv.ts -qm src/qt/locale/bitcoin_sv.qm

src/qt/locale/bitcoin_th_TH.qm: src/qt/locale/bitcoin_th_TH.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_th_TH.ts -qm src/qt/locale/bitcoin_th_TH.qm

src/qt/locale/bitcoin_tr.qm: src/qt/locale/bitcoin_tr.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_tr.ts -qm src/qt/locale/bitcoin_tr.qm

src/qt/locale/bitcoin_uk.qm: src/qt/locale/bitcoin_uk.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_uk.ts -qm src/qt/locale/bitcoin_uk.qm

src/qt/locale/bitcoin_ur_PK.qm: src/qt/locale/bitcoin_ur_PK.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_ur_PK.ts -qm src/qt/locale/bitcoin_ur_PK.qm

src/qt/locale/bitcoin_vi.qm: src/qt/locale/bitcoin_vi.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_vi.ts -qm src/qt/locale/bitcoin_vi.qm

src/qt/locale/bitcoin_vi_VN.qm: src/qt/locale/bitcoin_vi_VN.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_vi_VN.ts -qm src/qt/locale/bitcoin_vi_VN.qm

src/qt/locale/bitcoin_zh_CN.qm: src/qt/locale/bitcoin_zh_CN.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_zh_CN.ts -qm src/qt/locale/bitcoin_zh_CN.qm

src/qt/locale/bitcoin_zh_TW.qm: src/qt/locale/bitcoin_zh_TW.ts
	/usr/lib64/qt/bin/lrelease src/qt/locale/bitcoin_zh_TW.ts -qm src/qt/locale/bitcoin_zh_TW.qm

compiler_moc_header_make_all: build/moc_bitcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_bitcoinaddressvalidator.cpp build/moc_statisticspage.cpp build/moc_blockbrowser.cpp build/moc_calcdialog.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_bitcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvalidatedtextedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp build/moc_stakereportdialog.cpp build/moc_sendmessagesdialog.cpp build/moc_sendmessagesentry.cpp build/moc_messagemodel.cpp build/moc_messagepage.cpp build/moc_anonsendconfig.cpp build/moc_addeditmncashnode.cpp build/moc_mncashnodeconfigdialog.cpp build/moc_masternodemanager.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_bitcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_bitcoinaddressvalidator.cpp build/moc_statisticspage.cpp build/moc_blockbrowser.cpp build/moc_calcdialog.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_bitcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvalidatedtextedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp build/moc_stakereportdialog.cpp build/moc_sendmessagesdialog.cpp build/moc_sendmessagesentry.cpp build/moc_messagemodel.cpp build/moc_messagepage.cpp build/moc_anonsendconfig.cpp build/moc_addeditmncashnode.cpp build/moc_mncashnodeconfigdialog.cpp build/moc_masternodemanager.cpp
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp

build/moc_transactiontablemodel.cpp: src/qt/transactiontablemodel.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/transactiontablemodel.h -o build/moc_transactiontablemodel.cpp

build/moc_addresstablemodel.cpp: src/qt/addresstablemodel.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/addresstablemodel.h -o build/moc_addresstablemodel.cpp

build/moc_optionsdialog.cpp: src/qt/optionsdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/optionsdialog.h -o build/moc_optionsdialog.cpp

build/moc_coincontroldialog.cpp: src/qt/coincontroldialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/coincontroldialog.h -o build/moc_coincontroldialog.cpp

build/moc_coincontroltreewidget.cpp: src/qt/coincontroltreewidget.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/coincontroltreewidget.h -o build/moc_coincontroltreewidget.cpp

build/moc_sendcoinsdialog.cpp: src/qt/sendcoinsdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/sendcoinsdialog.h -o build/moc_sendcoinsdialog.cpp

build/moc_addressbookpage.cpp: src/qt/addressbookpage.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/addressbookpage.h -o build/moc_addressbookpage.cpp

build/moc_signverifymessagedialog.cpp: src/qt/signverifymessagedialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/signverifymessagedialog.h -o build/moc_signverifymessagedialog.cpp

build/moc_aboutdialog.cpp: src/qt/aboutdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/aboutdialog.h -o build/moc_aboutdialog.cpp

build/moc_editaddressdialog.cpp: src/qt/editaddressdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/editaddressdialog.h -o build/moc_editaddressdialog.cpp

build/moc_bitcoinaddressvalidator.cpp: src/qt/bitcoinaddressvalidator.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/bitcoinaddressvalidator.h -o build/moc_bitcoinaddressvalidator.cpp
...
build/moc_statisticspage.cpp: src/qt/clientmodel.h \
	...
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/statisticspage.h -o build/moc_statisticspage.cpp
...
build/moc_blockbrowser.cpp: src/qt/clientmodel.h \
	...
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/blockbrowser.h -o build/moc_blockbrowser.cpp

build/moc_calcdialog.cpp: src/qt/calcdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/calcdialog.h -o build/moc_calcdialog.cpp

build/moc_clientmodel.cpp: src/qt/clientmodel.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/clientmodel.h -o build/moc_clientmodel.cpp

build/moc_guiutil.cpp: src/qt/guiutil.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/guiutil.h -o build/moc_guiutil.cpp

build/moc_optionsmodel.cpp: src/qt/optionsmodel.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/optionsmodel.h -o build/moc_optionsmodel.cpp

build/moc_monitoreddatamapper.cpp: src/qt/monitoreddatamapper.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/monitoreddatamapper.h -o build/moc_monitoreddatamapper.cpp

build/moc_transactiondesc.cpp: src/qt/transactiondesc.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/transactiondesc.h -o build/moc_transactiondesc.cpp

build/moc_transactiondescdialog.cpp: src/qt/transactiondescdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/transactiondescdialog.h -o build/moc_transactiondescdialog.cpp

build/moc_bitcoinamountfield.cpp: src/qt/bitcoinamountfield.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/bitcoinamountfield.h -o build/moc_bitcoinamountfield.cpp

build/moc_transactionfilterproxy.cpp: src/qt/transactionfilterproxy.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/transactionfilterproxy.h -o build/moc_transactionfilterproxy.cpp

build/moc_transactionview.cpp: src/qt/transactionview.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/transactionview.h -o build/moc_transactionview.cpp
...
build/moc_walletmodel.cpp: src/allocators.h \
	...
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/walletmodel.h -o build/moc_walletmodel.cpp

build/moc_overviewpage.cpp: src/qt/overviewpage.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/overviewpage.h -o build/moc_overviewpage.cpp

build/moc_csvmodelwriter.cpp: src/qt/csvmodelwriter.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/csvmodelwriter.h -o build/moc_csvmodelwriter.cpp

build/moc_sendcoinsentry.cpp: src/qt/sendcoinsentry.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/sendcoinsentry.h -o build/moc_sendcoinsentry.cpp

build/moc_qvalidatedlineedit.cpp: src/qt/qvalidatedlineedit.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/qvalidatedlineedit.h -o build/moc_qvalidatedlineedit.cpp

build/moc_qvalidatedtextedit.cpp: src/qt/qvalidatedtextedit.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/qvalidatedtextedit.h -o build/moc_qvalidatedtextedit.cpp

build/moc_qvaluecombobox.cpp: src/qt/qvaluecombobox.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/qvaluecombobox.h -o build/moc_qvaluecombobox.cpp

build/moc_askpassphrasedialog.cpp: src/qt/askpassphrasedialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/askpassphrasedialog.h -o build/moc_askpassphrasedialog.cpp

build/moc_notificator.cpp: src/qt/notificator.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/notificator.h -o build/moc_notificator.cpp

build/moc_rpcconsole.cpp: src/qt/rpcconsole.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/rpcconsole.h -o build/moc_rpcconsole.cpp

build/moc_stakereportdialog.cpp: src/qt/stakereportdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/stakereportdialog.h -o build/moc_stakereportdialog.cpp

build/moc_sendmessagesdialog.cpp: src/qt/sendmessagesdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/sendmessagesdialog.h -o build/moc_sendmessagesdialog.cpp

build/moc_sendmessagesentry.cpp: src/qt/sendmessagesentry.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/sendmessagesentry.h -o build/moc_sendmessagesentry.cpp
...
build/moc_messagemodel.cpp: src/uint256.h \
	...
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/messagemodel.h -o build/moc_messagemodel.cpp

build/moc_messagepage.cpp: src/qt/messagepage.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/messagepage.h -o build/moc_messagepage.cpp

build/moc_anonsendconfig.cpp: src/qt/anonsendconfig.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/anonsendconfig.h -o build/moc_anonsendconfig.cpp

build/moc_addeditmncashnode.cpp: src/qt/addeditmncashnode.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/addeditmncashnode.h -o build/moc_addeditmncashnode.cpp

build/moc_mncashnodeconfigdialog.cpp: src/qt/mncashnodeconfigdialog.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/mncashnodeconfigdialog.h -o build/moc_mncashnodeconfigdialog.cpp
...
build/moc_masternodemanager.cpp: src/util.h \
	...
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/masternodemanager.h -o build/moc_masternodemanager.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/mncash-16.png \
		src/qt/res/icons/bitcoin.png \
		src/qt/res/icons/key.png \
		src/qt/res/icons/tx_inout.png \
		src/qt/res/icons/remove.png \
		src/qt/res/icons/forum.png \
		src/qt/res/icons/mncash-16.png \
	...
	/usr/lib64/qt/bin/rcc -name bitcoin src/qt/bitcoin.qrc -o qrc_bitcoin.cpp
...
build/overviewpage.moc: src/qt/overviewpage.h \
		...
		src/qt/overviewpage.cpp
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) src/qt/overviewpage.cpp -o build/overviewpage.moc
...
build/ui_coincontroldialog.h: src/qt/forms/coincontroldialog.ui \
	...
	/usr/lib64/qt/bin/uic src/qt/forms/coincontroldialog.ui -o build/ui_coincontroldialog.h

build/ui_sendcoinsdialog.h: src/qt/forms/sendcoinsdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/sendcoinsdialog.ui -o build/ui_sendcoinsdialog.h

build/ui_addressbookpage.h: src/qt/forms/addressbookpage.ui
	/usr/lib64/qt/bin/uic src/qt/forms/addressbookpage.ui -o build/ui_addressbookpage.h

build/ui_signverifymessagedialog.h: src/qt/forms/signverifymessagedialog.ui \
		src/qt/qvalidatedlineedit.h
	/usr/lib64/qt/bin/uic src/qt/forms/signverifymessagedialog.ui -o build/ui_signverifymessagedialog.h

build/ui_aboutdialog.h: src/qt/forms/aboutdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/aboutdialog.ui -o build/ui_aboutdialog.h

build/ui_editaddressdialog.h: src/qt/forms/editaddressdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/editaddressdialog.ui -o build/ui_editaddressdialog.h

build/ui_transactiondescdialog.h: src/qt/forms/transactiondescdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/transactiondescdialog.ui -o build/ui_transactiondescdialog.h

build/ui_overviewpage.h: src/qt/forms/overviewpage.ui
	/usr/lib64/qt/bin/uic src/qt/forms/overviewpage.ui -o build/ui_overviewpage.h

build/ui_sendcoinsentry.h: src/qt/forms/sendcoinsentry.ui \
		src/qt/qvalidatedlineedit.h \
		src/qt/bitcoinamountfield.h
	/usr/lib64/qt/bin/uic src/qt/forms/sendcoinsentry.ui -o build/ui_sendcoinsentry.h

build/ui_statisticspage.h: src/qt/forms/statisticspage.ui
	/usr/lib64/qt/bin/uic src/qt/forms/statisticspage.ui -o build/ui_statisticspage.h

build/ui_blockbrowser.h: src/qt/forms/blockbrowser.ui
	/usr/lib64/qt/bin/uic src/qt/forms/blockbrowser.ui -o build/ui_blockbrowser.h

build/ui_askpassphrasedialog.h: src/qt/forms/askpassphrasedialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/askpassphrasedialog.ui -o build/ui_askpassphrasedialog.h

build/ui_rpcconsole.h: src/qt/forms/rpcconsole.ui
	/usr/lib64/qt/bin/uic src/qt/forms/rpcconsole.ui -o build/ui_rpcconsole.h

build/ui_chatwindow.h: src/qt/forms/chatwindow.ui
	/usr/lib64/qt/bin/uic src/qt/forms/chatwindow.ui -o build/ui_chatwindow.h

build/ui_sendmessagesdialog.h: src/qt/forms/sendmessagesdialog.ui \
		src/qt/qvalidatedlineedit.h
	/usr/lib64/qt/bin/uic src/qt/forms/sendmessagesdialog.ui -o build/ui_sendmessagesdialog.h

build/ui_sendmessagesentry.h: src/qt/forms/sendmessagesentry.ui \
		src/qt/qvalidatedlineedit.h \
		src/qt/qvalidatedtextedit.h
	/usr/lib64/qt/bin/uic src/qt/forms/sendmessagesentry.ui -o build/ui_sendmessagesentry.h

build/ui_messagepage.h: src/qt/forms/messagepage.ui
	/usr/lib64/qt/bin/uic src/qt/forms/messagepage.ui -o build/ui_messagepage.h

build/ui_optionsdialog.h: src/qt/forms/optionsdialog.ui \
		src/qt/qvalidatedlineedit.h \
		src/qt/bitcoinamountfield.h \
		src/qt/qvaluecombobox.h
	/usr/lib64/qt/bin/uic src/qt/forms/optionsdialog.ui -o build/ui_optionsdialog.h

build/ui_stakereportdialog.h: src/qt/forms/stakereportdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/stakereportdialog.ui -o build/ui_stakereportdialog.h

build/ui_anonsendconfig.h: src/qt/forms/anonsendconfig.ui
	/usr/lib64/qt/bin/uic src/qt/forms/anonsendconfig.ui -o build/ui_anonsendconfig.h

build/ui_addeditmncashnode.h: src/qt/forms/addeditmncashnode.ui
	/usr/lib64/qt/bin/uic src/qt/forms/addeditmncashnode.ui -o build/ui_addeditmncashnode.h

build/ui_mncashnodeconfigdialog.h: src/qt/forms/mncashnodeconfigdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/mncashnodeconfigdialog.ui -o build/ui_mncashnodeconfigdialog.h

build/ui_masternodemanager.h: src/qt/forms/masternodemanager.ui
	/usr/lib64/qt/bin/uic src/qt/forms/masternodemanager.ui -o build/ui_masternodemanager.h

build/ui_calcdialog.h: src/qt/forms/calcdialog.ui
	/usr/lib64/qt/bin/uic src/qt/forms/calcdialog.ui -o build/ui_calcdialog.h
...
build/anonsendconfig.o: src/qt/anonsendconfig.cpp src/qt/anonsendconfig.h \
		build/ui_anonsendconfig.h \
		src/qt/bitcoinunits.h \
		src/qt/guiconstants.h \
		src/qt/optionsmodel.h \
		src/qt/walletmodel.h \
		...
		src/db.h \
		src/init.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/anonsendconfig.o src/qt/anonsendconfig.cpp
...
build/anonsend.o: src/anonsend.cpp src/anonsend.h \
		src/main.h \
		src/bignum.h \
		src/serialize.h \
		src/allocators.h \
		...
		src/db.h \
		src/instantx.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/anonsend.o src/anonsend.cpp

build/rpcanonsend.o: src/rpcanonsend.cpp src/main.h \
		src/bignum.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		...
		src/json/json_spirit_utils.h \
		src/checkpoints.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/rpcanonsend.o src/rpcanonsend.cpp
...
build/addeditmncashnode.o: src/qt/addeditmncashnode.cpp src/qt/addeditmncashnode.h \
		build/ui_addeditmncashnode.h \
		src/walletdb.h \
		src/db.h \
		src/main.h \
		src/bignum.h \
		...
		src/ui_interface.h \
		src/init.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/addeditmncashnode.o src/qt/addeditmncashnode.cpp

build/mncashnodeconfigdialog.o: src/qt/mncashnodeconfigdialog.cpp src/qt/mncashnodeconfigdialog.h \
		build/ui_mncashnodeconfigdialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mncashnodeconfigdialog.o src/qt/mncashnodeconfigdialog.cpp
...
build/moc_anonsendconfig.o: build/moc_anonsendconfig.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_anonsendconfig.o build/moc_anonsendconfig.cpp

build/moc_addeditmncashnode.o: build/moc_addeditmncashnode.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_addeditmncashnode.o build/moc_addeditmncashnode.cpp

build/moc_mncashnodeconfigdialog.o: build/moc_mncashnodeconfigdialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_mncashnodeconfigdialog.o build/moc_mncashnodeconfigdialog.cpp
