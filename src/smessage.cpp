...
// Copyright (c) 2014 The MNcash developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("mncash-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("mncash-smsg-pow"); // Make this thread recognisable
