...
namespace Checkpoints
{
    ...
    // MNcash: synchronized checkpoint (centrally broadcasted)
    ...
    // MNcash: get last synchronized checkpoint
    ...
    // MNcash: only descendant of current sync-checkpoint is allowed
    ...
    // MNcash: reset synchronized checkpoint to last hardened checkpoint
...
// MNcash: sync-checkpoint master key
...
// MNcash: verify signature of sync-checkpoint message
...
// MNcash: process synchronized checkpoint
