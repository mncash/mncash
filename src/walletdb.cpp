...
bool CWalletDB::WriteMNcashNodeConfig(std::string sAlias, const CMNcashNodeConfig& nodeConfig)
{
 nWalletDBUpdated++;
 return Write(std::make_pair(std::string("mncash"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadMNcashNodeConfig(std::string sAlias, CMNcashNodeConfig& nodeConfig)
{
 return Read(std::make_pair(std::string("mncash"), sAlias), nodeConfig);
}

bool CWalletDB::EraseMNcashNodeConfig(std::string sAlias)
{
 nWalletDBUpdated++;
 return Erase(std::make_pair(std::string("mncash"), sAlias));
}
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
	...
	else if (strType == "mncash")
	{
	    std::string sAlias;
	    ssKey >> sAlias;
	    CMNcashNodeConfig mncashNodeConfig;
	    ssValue >> mncashNodeConfig;
	    pwallet->mapMyMNcashNodes.insert(make_pair(sAlias, mncashNodeConfig));
	}
    } catch (...)
    {
        return false;
